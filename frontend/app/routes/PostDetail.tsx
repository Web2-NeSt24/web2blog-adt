      ...
      <article className="post-detail-card">
          ...
          <div className="post-author">
            <div className="author-avatar">
              {post.profile.profile_picture ? (
                <img src={post.profile.profile_picture} alt={post.profile.user.username} />
              ) : (
        ...
        {post.image && (
          <div className="post-image-container">
            <img src={post.image} alt="Post featured image" className="post-image" />
          </div>
        )}
                ...
                <div className="comment-author">
                  <div className="comment-avatar">
                    {comment.author_profile.profile_picture ? (
                      <img src={comment.author_profile.profile_picture} alt={comment.author_profile.user.username} />
                    ) : (
                      <div className="avatar-placeholder">
